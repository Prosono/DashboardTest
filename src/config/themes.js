...
export const themes = {
  contextual: {
    ...
    colors: {
      ...
      '--status-success-border': 'rgba(74, 222, 128, 0.26)',
      ...
      '--status-danger-border': 'rgba(252, 165, 165, 0.28)',
      '--status-danger-text': '#fecaca',
      '--status-neutral-bg': 'rgba(148, 163, 184, 0.14)',
      '--status-neutral-border': 'rgba(203, 213, 225, 0.18)',
  ...
  dark: {
    ...
    colors: {
      ...
      '--status-warning-text': '#fde68a',
      '--status-danger-bg': 'rgba(248, 113, 113, 0.14)',
      '--status-danger-border': 'rgba(252, 165, 165, 0.26)',
      '--status-danger-text': '#fecaca',
      '--status-neutral-bg': 'rgba(59, 130, 246, 0.12)',
      '--status-neutral-border': 'rgba(125, 211, 252, 0.22)',
      '--status-neutral-text': '#dbeafe',
  ...
  graphite: {
    ...
    colors: {
      ...
      '--status-success-bg': 'rgba(34, 197, 94, 0.14)',
      '--status-success-border': 'rgba(74, 222, 128, 0.24)',
      '--status-success-text': '#bbf7d0',
      ...
      '--status-danger-border': 'rgba(252, 165, 165, 0.26)',
      '--status-danger-text': '#fecaca',
      '--status-neutral-bg': 'rgba(163, 163, 184, 0.14)',
      '--status-neutral-border': 'rgba(228, 228, 231, 0.16)',
      '--status-neutral-text': '#e4e4e7',
  ...
  amethyst: {
    ...
    colors: {
      ...
      '--status-success-bg': 'rgba(34, 197, 94, 0.14)',
      '--status-success-border': 'rgba(74, 222, 128, 0.24)',
      '--status-success-text': '#dcfce7',
      '--status-warning-bg': 'rgba(245, 158, 11, 0.16)',
      '--status-warning-border': 'rgba(251, 191, 36, 0.28)',
      '--status-warning-text': '#fde68a',
      '--status-danger-bg': 'rgba(248, 113, 113, 0.14)',
      '--status-danger-border': 'rgba(252, 165, 165, 0.28)',
      '--status-danger-text': '#fecdd3',
      '--status-neutral-bg': 'rgba(216, 180, 254, 0.14)',
      '--status-neutral-border': 'rgba(216, 180, 254, 0.22)',
      '--status-neutral-text': '#f3e8ff',
  ...
  flat: {
    ...
    colors: {
      ...
      '--status-success-bg': 'rgba(34, 197, 94, 0.14)',
      '--status-success-border': 'rgba(74, 222, 128, 0.22)',
      '--status-success-text': '#bbf7d0',
      '--status-warning-bg': 'rgba(245, 158, 11, 0.14)',
      '--status-warning-border': 'rgba(251, 191, 36, 0.24)',
      '--status-warning-text': '#fde68a',
      '--status-danger-bg': 'rgba(239, 68, 68, 0.14)',
      '--status-danger-border': 'rgba(248, 113, 113, 0.24)',
      '--status-danger-text': '#fecaca',
      '--status-neutral-bg': 'rgba(56, 189, 248, 0.14)',
      '--status-neutral-border': 'rgba(125, 211, 252, 0.22)',
      '--status-neutral-text': '#e0f2fe',
