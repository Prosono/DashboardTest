...
import {
  ...
  downloadPlatformRawLog as downloadServerPlatformRawLog,
  ...
  fetchUnifiMobilityInventory as fetchServerUnifiMobilityInventory,
  fetchUnifiMobilityDevice as fetchServerUnifiMobilityDevice,
  saveNetworkSite as saveServerNetworkSite,
  applyNetworkSite as applyServerNetworkSite,
  rotateNetworkSiteWireGuardKeys as rotateServerNetworkSiteWireGuardKeys,
  ...
  runRemoteInstanceHealthCheck as runServerRemoteInstanceHealthCheck,
...
function AppContent({
  ...
  useEffect(() => {
    ...
    const warningPill = {
      ...
      iconBgColor: 'rgba(245, 158, 11, 0.24)',
  ...
  const renderCard = (cardId, index, colIndex) => {
    ...
    const ctx = {
      ...
      notificationAlertEntityIds: { warning: WARNING_SENSOR_ID, critical: CRITICAL_SENSOR_ID },
    ...
    >
      ...
      {isMobile && navStickyOnScrollDown && (
        <div
          ...
          style={{
            top: 0,
            height: `${Math.max(0, navPinTopPx + 1)}px`,
            backdropFilter: 'blur(10px) saturate(120%)',
            WebkitBackdropFilter: 'blur(10px) saturate(120%)',
            background: isLightTheme
              ? 'linear-gradient(to bottom, rgba(248, 250, 252, 0.36) 0%, rgba(248, 250, 252, 0.28) 100%)'
              : 'linear-gradient(to bottom, rgba(2, 6, 23, 0.36) 0%, rgba(2, 6, 23, 0.28) 100%)',
          }}
        />
      )}
...
export default function App() {
  ...
  const userAdminApi = useMemo(() => ({
    ...
    fetchUnifiMobilityInventory: fetchServerUnifiMobilityInventory,
    fetchUnifiMobilityDevice: fetchServerUnifiMobilityDevice,
    saveNetworkSite: saveServerNetworkSite,
    applyNetworkSite: applyServerNetworkSite,
    rotateNetworkSiteWireGuardKeys: rotateServerNetworkSiteWireGuardKeys,
    ...
    downloadPlatformRawLog: downloadServerPlatformRawLog,
    ...
    runRemoteInstanceHealthCheck: runServerRemoteInstanceHealthCheck,
