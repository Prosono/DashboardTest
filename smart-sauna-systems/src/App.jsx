  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          ref={navRowRef}
          className={`${isMobile ? 'flex flex-col items-center gap-3' : 'flex flex-nowrap items-center justify-between gap-4'} ${navStickyOnScrollDown ? 'sticky z-30 transition-all duration-200' : ''}`}
          style={{
